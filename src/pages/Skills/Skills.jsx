...
const SkillsSection = () => {
  const skillCategories = [
    {
      ...
      skills: [
        { name: "React", icon: <FaReact className="w-4 h-4 text-[#61DAFB]" /> },
        {
          ...
          {
          name: "Javascript",
          icon: <SiJavascript className="w-4 h-4 text-[#fbff00]" />,
        },
        {
          name: "TypeScript",
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Adobe Photoshop", icon: <SiAdobephotoshop className="w-4 h-4 text-[#0080ff]" /> },
        {
  ...
  return (
    <main className="pt-15 lg:pt-0 text-white min-h-screen bg-[#04081A] relative">
      ...
      <section ref={containerRef} className="container mx-auto px-4 py-11 relative z-10">
        <motion.div
