        ...
        >
          ...
          >
            <rect
              ...
              stroke="white"
              strokeWidth="0.5"
              className="opacity-60 animate-gridPulse"
            />
          </pattern>
      ...
      <main className="bg-[#020617] text-white min-h-screen">
        ...
        >
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              {/* Welcome badge */}
              <div className="inline-flex items-center gap-2 px-5 sm:px-4 py-3 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 mb-6 sm:mb-8 animate__animated animate__fadeInDown animate__delay-1s m-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Harrish87"
                ...
                {/* Contact Button */}
                <a
                  href="https://pdflink.to/harrishesume/"
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce flex flex-col items-center gap-2">
          <span className="text-gray-400 flex items-center">
            <i className="fas fa-mouse text-blue-900"></i>
            About me
          </span>
